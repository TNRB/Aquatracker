...
2. MenuController
	...
	-The menu options are as follows:
		1. Budget-Based Calculator (budgetCalculator())
		   -Asks for a budget.
...
4. StandardBillCalculator
	-It performs the actual billing computations as needed by the program.
	-Conducts a 4 step method:
		1. Utilizes the formula waterCharge = usage * RATE.
		2. Add environmental fee.
		3. Compute VAT on subtotal.
		4. Return final bill.
